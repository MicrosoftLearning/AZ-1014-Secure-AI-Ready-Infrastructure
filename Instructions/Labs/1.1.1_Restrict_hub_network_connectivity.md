---
lab:
  title: 'AI Ready Security hands-on exercise: Configure Microsoft Foundry hub network connectivity by using a managed network'
  description: Configure Microsoft Foundry hub network connectivity by using a managed network.
  duration: 25 minutes
  level: 500
  islab: true
  primarytopics:
