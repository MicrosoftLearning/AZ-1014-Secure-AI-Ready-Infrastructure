---
lab:
  title: 'AI Ready Security hands-on exercise: Protect Microsoft Foundry by using Microsoft Entra ID Conditional Access'
  description: Protect Microsoft Foundry by using Microsoft Entra ID Conditional Access.
  duration: 15 minutes
  level: 400
  islab: true
  primarytopics:
