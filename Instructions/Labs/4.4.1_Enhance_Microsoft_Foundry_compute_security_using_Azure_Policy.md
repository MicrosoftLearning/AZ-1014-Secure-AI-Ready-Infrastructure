---
lab:
  title: 'AI Ready Security hands-on exercise: Enhance security of Microsoft Foundry compute resources by using Azure Policy'
  description: Enhance security of Microsoft Foundry compute resources by using Azure Policy.
  duration: 15 minutes
  level: 300
  islab: true
  primarytopics:
