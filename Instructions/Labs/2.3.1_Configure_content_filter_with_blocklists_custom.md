---
lab:
  title: 'AI Ready Security hands-on exercise: Create a custom blocklist'
  description: The configurable content filters are sufficient for most content moderation needs. However, you might need to create custom blocklists in the Microsoft Foundry portal as part of your content filtering configurations to filter terms specific to your use case.
  duration: 15 minutes
  level: 200
  islab: true
  primarytopics:
