---
lab:
  title: 'AI Ready Manage hands-on exercise: Implement Microsoft Foundry standard
    agent setup'
  description: 'Foundry Agent Service enables creating AI agents through a two-step
    flow: first establishing an agent environment, and then creating and configuring
    the agent using an SDK or the Azure Foundry portal.'
  duration: 20 minutes
  level: 500
  islab: true
  primarytopics:
